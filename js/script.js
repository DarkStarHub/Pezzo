...
document.body.addEventListener("touchstart",(e)=> {     
    cursorMine.style.transform = `translate3d(300vw, 300vh, 0)`;  
    cursorShown = false;
});
...
function calcZoom()
{
    //console.log(clampNumber(window.innerHeight/window.innerWidth,.5,1.2)*2);
